  ...
  return (
    <SafeAreaView className="flex-1 bg-[#343541]">
      <View className="flex-1 justify-between">
        ...
        <Animated.View 
          ...
          style={{
            ...
            transform: [
              { scale: creativeImageAnim.interpolate({ inputRange: [0, 1], outputRange: [0.3, 1] }) },
              { translateY: creativeImageAnim.interpolate({ inputRange: [0, 1], outputRange: [50, 0] }) }
            ],
          }}
        >
          <Image
        ...
        <View className="flex-1 justify-center items-center px-8 my-8">
          ...
          <Text className="text-center text-xl text-gray-300 px-4 leading-8">
            Your AI-powered <Youtube size={28} color="red" /> script writing assistant. 
            Create engaging <Text className="text-white font-semibold">content effortlessly.</Text>
          </Text>
        </View>
        ...
        <View className="gap-6 px-8 pb-12 mb-8">
          <Link href="/(auth)/sign-up" asChild>
            <Pressable className="w-full rounded-xl bg-[#10a37f] py-4 shadow-lg active:bg-[#0e906f]">
          ...
          <Link href="/(auth)/sign-in" asChild>
            <Pressable className="w-full rounded-xl border-2 border-gray-600 bg-transparent py-4 active:bg-gray-700">
              <Text className="text-center text-lg font-bold text-white">
          ...
          <Text className="text-center text-sm text-gray-400">
            ...
            <Text className="text-[#10a37f]" onPress={() => setPrivacyModalVisible(true)}>
              Privacy Policy
            </Text>
          </Text>
        </View>
      ...
      <Modal
        ...
        useNativeDriver
      >
        <View className="bg-[#343541] rounded-2xl p-6 max-h-[80%]">
          ...
          <ScrollView className="flex-grow" showsVerticalScrollIndicator>
          ...
          <Pressable className="w-full rounded-xl bg-[#10a37f] p-4 mt-4 shadow-sm active:bg-[#0e906f]" onPress={() => setPrivacyModalVisible(false)}>
