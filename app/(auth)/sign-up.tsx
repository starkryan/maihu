  ...
  const SignUpScreen: React.FC = () => {
    ...
    const resendVerificationCode = async () => {
      ...
      if (!isConnected) {
        ...
        toastError('No internet connection. Please check your network and try again.');
        return;
      }
    ...
    const handleBack = () => {
      if (currentStep === 'otp') {
        ...
        // On form step, navigate to sign-in
    ...
    }, [handleOAuth, isGoogleLoading, isConnected]);
    ...
    const checkEmailExists = async (email: string) => {
      ...
      if (!isConnected) {
        ...
        return; // Silently fail email check when offline
      }
    ...
    const renderNetworkStatus = () => {
      ...
      return (
        <View className="absolute top-0 left-0 right-0 bg-red-500 px-4 py-2 z-50">
